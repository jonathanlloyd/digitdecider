...
def main():
    ...
    training_data_loader = make_training_data_loader()
    test_data_loader = make_test_data_loader()

    params = init_model_parameters()

    epoch = 0
    while True:
        epoch_loss = run_epoch(training_data_loader, params)
        epoch_accuracy = evaluate_model(test_data_loader, params)
